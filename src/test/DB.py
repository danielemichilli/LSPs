...
puls = pd.read_hdf('sp/SinlgePulses.hdf5',idL+'_pulses')
...
data = pd.read_hdf('sp/SinlgePulses.hdf5',idL)
...
parameters_name = open("Parameter Names - {}".format(idL),'w')

out_file.write('Observation {}\n\n'.format(idL))
parameters_name.write('Observation\n\n')
parameters.write('{}\n\n'.format(idL))
...
for [puls,rfi_puls] in [[pulsA,rfiA],[pulsB,rfiB]]:#,[pulsC,rfiC]]:
  ...
  out_file.write('Pulses formed by a number of elements between {} and {}\n\n'.format(N_events.min(),N_events.max()))
  out_file.write( 'Astrophysical pulses: {} ({} of total in the DM range)\nRFIs: {}\n\n'.format(num,float(num)/(num+rfi)*100.,len(rfi_puls)))
  
  parameters_name.write('Number of elements between {} and {}\n\n'.format(N_events.min(),N_events.max()))
  parameters.write('{}\n\n'.format(num))
  ...
  out_file.write( "\n\n-------------------------------------\n\npuls.Duration\n")
  parameters_name.write('puls.Duration\n\n\n\n\n')
  ...
  parameters_name.write('puls.dDM/(N_events-1)/step\n\n\n\n\n')
  ...
  out_file.write( "\n\n-------------------------------------\n\nN_events/puls.Sigma\n")  
  parameters_name.write('N_events/puls.Sigma\n\n\n\n\n')
  ...
  parameters_name.write('abs(puls.DM-puls.DM_c)/puls.dDM\n\n\n\n\n')
  ...
  parameters_name.write('abs(puls.DM-puls.DM_c)/puls.dDM**4\n\n\n\n\n')
  ...
  parameters_name.write('puls.Sigma/Sigma_min\n\n\n\n\n')
  ...
  parameters_name.write('puls.Sigma/Sigma_min**4\n\n\n\n\n')
  ...
  parameters_name.write('abs(Sigma_DM_max-Sigma_DM_min)\n\n\n\n\n')
  ...
  parameters_name.write('gb.Time.apply(np.var)\n\n\n\n\n')
